                            ...
                            if ($dh = opendir($ruta)){
                                ...
                                while (($file = readdir($dh)) !== false){    
                                    if ($file!="." && $file!=".."){
                                        ...
                                        echo "<div style='display: inline-block; float: right'>";
                                        echo "<a href= 'amarchivo.php' value='Modificar' class='btn btn-outline-secondary'>Modificar</a>";
                                        echo "<a href= 'compartirarchivo.php' value='nocompartir' class='btn btn-outline-warning'>Dejar de compartir</a>";
                                        echo "<a href= 'eliminararchivocompartido.php' value='Eliminar' class='btn btn-outline-danger'>Eliminar</a>";
                                        echo "</div>";
                                        echo "</li>";
                                        echo "</br>";
